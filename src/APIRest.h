...
// bool APIRest::POSTIssue(string url,string token,string device,string message,string type="generic",string date=APIRest::getInstance()->getActualDate()){
  // if(!TESTING){
...
// string APIRest::parseResponse( string response, string fieldName, bool quotedField = true ){
